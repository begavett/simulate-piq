    ...
    sidebarLayout(
        sidebarPanel(
            ...
            numericInput("z_cutoff",
                         ...
                         step = .01),
            numericInput("br_cd",
                         "Base rate of cognitive impairment in the population:",
                         min = .05,
                         max = .95,
                         value = .4,
                         step = .01),
            numericInput("delta_cd",
                         "Population effect size of cognitive impairment on cognitive test (number of standard deviations from the mean):",
                         min = -3,
                         max = -.01,
                         value = -.70,
                         step = .01),
